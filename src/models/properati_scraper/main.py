...
import time
import random
import logging  # <-- Asegúrate que esta línea esté presente
from datetime import datetime
from bs4 import BeautifulSoup

from drivers import WebDriverController
from scrapers.listing_scraper import ListingScraper
from scrapers.detail_scraper import DetailScraper
from scrapers.project_scraper import ProjectScraper
from utils.helpers import ensure_folder_exists, human_pause
from utils.file_handlers import DataHandler
from config import (
        ...
        try:
            ...
            for section in sections:
                ...
                for page in range(1, self.max_pages + 1):
                    ...
                    # Build URL
                    if page == 1:
                        url = f"{BASE_URL}/s/{section}"
                    else:
                        url = f"{BASE_URL}/s/{section}/{page}"
